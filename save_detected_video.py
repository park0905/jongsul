...
fc = 30.0
capture = cv2.VideoCapture('testvideo/fighttest23.mp4')
capture.set(3, 720) 
capture.set(4, 1080) 
codec = cv2.VideoWriter_fourcc('D', 'I', 'V', 'X') 
writer = cv2.VideoWriter('testvideo/savedvideo(4000)/detected_fighttest23.avi', codec, fc, (int(capture.get(3)), int(capture.get(4))))
